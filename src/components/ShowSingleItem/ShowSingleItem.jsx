    ...
    <div className="color-filter">
        {colorAttributes.map(color => (
            <span
                ...
                style={
                    activeColorItem === color.attribute_value
                        ? activeColorItemStyle
                        : {}
                }
...
const filterSize = (
    ...
    <div className="size-filter">
        {sizeAttributes.map(size => (
            <span
                style={
                    activeSizeItem === size.attribute_value
                        ? activeSizeItemStyle
                        : {}
                }
        ...
        <div className="preview-thumbnail-image">
            <ul className="preview-thumbnail nav nav-tabs">
                <li>
                    <img
                        alt="black here"
                        src={image_store.IMAGE_URL + productDetails.image}
                    />
                </li>
                <li>
                    <img
                        alt="black here"
                        src={image_store.IMAGE_URL + productDetails.image_2}
                    />
                </li>
            </ul>
        </div>
