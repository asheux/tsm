    ...
    handleClick = e => {
        ...
        stripe.createToken({ name: "brian mboya" }).then(({ token }) => {
            if (orderID) {
                ...
                this.setState({
                    payError: "Please place an order and try again!"
                });
            }
        });
    };
            ...
            <div className="container shipping-container">
                <div className="row shipping checkout">
                    <form className="col-md-12" onSubmit={handleSubmit}>
                        <CustomerAddressForm {...this.props} />
                        <br />
                        <div className="row">
                        ...
                        <div className="row">
                            <div
                                className="review-form-desc col-md-6"
                                noValidate="novalidate"
                            >
                                <label className="control-label" htmlFor="desc">
                                    Description *
                                </label>
                                <textarea
